...
from drones.models import DroneCategory, Pilot, Competition

@admin.register(Drone)
class DroneAdmin(admin.ModelAdmin):
    list_display = ('name', 'drone_category', 'manufacturing_date', 'has_it_competed', 'is_published', 'display_picture', 'owner')
